...
// Kuraray
  G4double Abs_WLS_PVT_Kuraray[nEntries_WLS_PVT_ABS] =
    { 28.4714*cm, 28.7315*cm, 29.1826*cm, 29.4881*cm, 29.8846*cm, // 700 --- 650
      27.3553*cm, 27.4461*cm, 27.4499*cm, 27.75*cm, 28.0151*cm, // 650 --- 600
      25.6977*cm, 26.0838*cm, 26.5238*cm, 26.7222*cm, 27.1791*cm, // 600 --- 550
      24.046*cm, 24.5068*cm, 24.6889*cm, 24.9526*cm, 25.4201*cm, // 550 --- 500
      22.4125*cm, 22.7998*cm, 23.1621*cm, 23.6395*cm, 23.8834*cm, // 500 --- 450
      0.339339*cm, 1.11414*cm, 9.9109*cm, 19.2105*cm, 21.7179*cm, // 450 --- 400
      0.336647*cm, 0.336643*cm, 0.335371*cm, 0.335741*cm, 0.335892*cm, // 400 --- 350
      0.938539*cm, 0.736589*cm, 0.500714*cm, 0.363022*cm, 0.338309*cm, // 350 --- 300
      0.287346*cm, 0.292294*cm, 0.30926*cm, 0.56531*cm, 0.881152*cm, // 300 --- 250
      0.294961*cm, 0.290387*cm, 0.289079*cm, 0.286571*cm, 0.285219*cm}; // 250 --- 200

// SKOD
  G4double Abs_WLS_PVT_SKOD[nEntries_WLS_PVT_ABS] =
    { 35.3607*cm, 35.3632*cm, 35.3357*cm, 35.5707*cm, 36.1677*cm, // 700 --- 650
      34.2489*cm, 34.3395*cm, 34.4317*cm, 34.5985*cm, 34.9284*cm, // 650 --- 600
      32.7804*cm, 33.4024*cm, 33.7872*cm, 33.9455*cm, 34.1332*cm, // 600 --- 550
      30.8138*cm, 31.4782*cm, 31.7289*cm, 31.9703*cm, 32.6286*cm, // 550 --- 500
      28.1793*cm, 28.8609*cm, 29.5281*cm, 30.2773*cm, 30.553*cm, // 500 --- 450
      0.95351*cm, 4.2372*cm, 19.3757*cm, 25.4039*cm, 27.1547*cm, // 450 --- 400
      0.688088*cm, 0.596954*cm, 0.568403*cm, 0.605188*cm, 0.855644*cm, // 400 --- 350
      1.30231*cm, 1.59356*cm, 1.41929*cm, 1.12434*cm, 0.860604*cm, // 350 --- 300
      0.265618*cm, 0.265469*cm, 0.26527*cm, 0.266881*cm, 0.525275*cm, // 300 --- 250
      0.274954*cm, 0.270449*cm, 0.269142*cm, 0.267404*cm, 0.265486*cm}; // 250 --- 200
...
#define NUMENTRIES_TY 33 // Number of bins of wavelength to be used for the Tyvek reflectivity
  ...
  MPTWLS_Water->AddProperty("RINDEX",PhotonEnergy_WLS_PVT,RIndex_WLS_PVT,nEntries_WLS_PVT);
  MPTWLS_Water->AddProperty("TRANSMITTANCE", PhotonEnergy_WLS_PVT, TransWaterWLS, NUMENTRIES_WLS);
  ...
  MPTWLS_Tyvek->AddProperty("RINDEX",PhotonEnergy_WLS_PVT,RIndex_WLS_PVT,nEntries_WLS_PVT);
