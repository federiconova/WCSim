...
void WCSimDetectorConstruction::NuPRISM_8inchPMT_40perCent()
{
  WCDetectorName = "NuPRISM_8inchPMT_40perCent";
  WCIDCollectionName = WCDetectorName +"-glassFaceWCPMT";
...
void WCSimDetectorConstruction::NuPRISM_big_8inchPMT_40perCent()
{
  WCDetectorName = "NuPRISM_big_8inchPMT_40perCent";
  WCIDCollectionName = WCDetectorName +"-glassFaceWCPMT";
  WCSimPMTObject * PMT = CreatePMTObject("PMT8inch", WCIDCollectionName);
  WCPMTName           = PMT->GetPMTName();
  WCPMTExposeHeight   = PMT->GetExposeHeight();
...
void WCSimDetectorConstruction::surface_detector_12inchPMT_40perCent()
{
  WCDetectorName = "surface_detector_12inchPMT_40perCent";
  WCIDCollectionName = WCDetectorName +"-glassFaceWCPMT";
  WCSimPMTObject * PMT = CreatePMTObject("HPD12inchHQE", WCIDCollectionName);
  WCPMTName           = PMT->GetPMTName();
  WCPMTExposeHeight   = PMT->GetExposeHeight();
...
void WCSimDetectorConstruction::e61_detector()
{
  WCDetectorName = "e61_detector";
  WCIDCollectionName = WCDetectorName +"-glassFaceWCPMT";
  WCSimPMTObject * PMT = CreatePMTObject("PMT3inch", WCIDCollectionName);
  WCPMTName           = PMT->GetPMTName();
  WCPMTExposeHeight   = PMT->GetExposeHeight();
