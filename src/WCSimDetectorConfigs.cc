...
void WCSimDetectorConstruction::SetHyperKWithODGeometry_20k_20inch_pmts()
{
  WCDetectorName = "HyperK";
  WCIDCollectionName = WCDetectorName +"-glassFaceWCPMT";
...
void WCSimDetectorConstruction::SetHyperKWithODGeometry_20k_3inch_pmts()
{
  WCDetectorName = "HyperK";
  WCIDCollectionName = WCDetectorName +"-glassFaceWCPMT";
...
void WCSimDetectorConstruction::SetHyperKWithODGeometry_20k_X16_3inch_pmts()
{
  WCDetectorName = "HyperK";
  WCIDCollectionName = WCDetectorName +"-glassFaceWCPMT";
...
// build 16 3 inch for each 20 inch in 40% coverage
  WCPMTPercentCoverage  = 7.2; // = (standard coverage) * (area ratio) * (n of tiles) =
                                // =         20          *   (3 / 20)^2 *    16  = 7.2
