...
pid = {"pi0":111, "pi+":211, "k0l":130, "k0s":310, "k+":321,
       ...
       "p+":2212, "n0":2112, "Bi214":1000832140,"Tl208":1000812080,"K40":1000190400}
...
def partPrint(p, f, recno):
    ...
    if randvert:
        ...
        #     if y**2 + z**2 < rad**2: break
        # x = random.uniform(-height/2,height/2)
        # NuPRISM_big
        rad = 800./2. - 20.
        height = 1000. - 20.
        while True:
...
for fileno in range(nfiles):
    ...
    filename="%s_%.0fMeV_%s_%s_%03i_NuPRISM_big.kin" % (typestr, energy, options.vertname, options.dirname, fileno)
